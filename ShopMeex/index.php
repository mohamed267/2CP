<!DOCTYPE html>
	<html>
		<head>
			...
			<link rel="stylesheet" type="text/css" href="Plugins/jquery-nice-select-1.1.0/css/nice-select.css">
		...
		<body>
										...
										<div class="product-cont">
											<div class="content">
												...
												<div>
													...
													<p class="original-price" title="Original Price">$59</p>
												</div>
											</div>
										</div>
									</div>
			...
			<script src="Plugins/jquery-nice-select-1.1.0/js/jquery.nice-select.js"></script>
